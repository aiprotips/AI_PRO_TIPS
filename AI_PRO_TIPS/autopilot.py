...
from builders import build_safe_combo_for_date
...
class Autopilot:
    ...
    def post_stat_flash(self):
        # Simple heuristic: pick random upcoming fixture and produce a stat-like sentence
    ...
    def post_value_scan(self):
        ...
        for fx in fixtures:
            ...
            # heuristic: Under 3.5 or 1X in range

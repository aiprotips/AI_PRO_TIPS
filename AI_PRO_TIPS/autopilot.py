...
from templates import (
    ...
    render_story_for_match, render_value_scanner
)
...
class Autopilot:
    ...
    def post_stat_flash(self):
        ...
        # prendo una delle partite whitelisted (usata anche nelle giocate)
        try:
    ...
    def post_value_single(self) -> bool:
        today = self._today_str()
    ...
    def post_combo_range(self, legs: int, lo: float, hi: float, label: str) -> bool:
        today = self._today_str()
